...
public class WStarButton extends WToggleButton {
    ...
    public enum State {
        STARRED(new Identifier(BetterAnvil.MOD_ID,"textures/gui/star/star.png")),
        LIGHT(new Identifier(BetterAnvil.MOD_ID,"textures/gui/star/star_light.png")),
        DARK(new Identifier(BetterAnvil.MOD_ID,"textures/gui/star/star_dark.png"));
