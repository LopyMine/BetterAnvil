...
public interface CEMDescription {
    LinkedHashSet<CEMItem> getSearchData(WTextField wTextField, LinkedHashSet<CEMItem> data);
    LinkedHashSet<CEMItem> getSearchPackData(WTextField wTextField, LinkedHashSet<CEMItem> data);
    LinkedHashSet<CEMItem> getPackItems(String pack);
    LinkedHashSet<CEMItem> getServerPackItems();
    int getWPos(int width);
    void clearButtons();
    void createFavoriteNameList(WPlainPanel root, LinkedHashSet<CEMItem> data);
    void createAllNameList(WPlainPanel root, LinkedHashSet<CEMItem> data);
    void setButtons();
