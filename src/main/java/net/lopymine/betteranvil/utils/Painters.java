...
public class Painters {
    public static final BackgroundPainter CONFIG_PAINTER = createLightDarkVariants(
            createNinePatch(new Identifier(BetterAnvil.MOD_ID,"textures/gui/painters/list_background_light.png")),
            createNinePatch(new Identifier(BetterAnvil.MOD_ID,"textures/gui/painters/list_background_dark.png"))
    );

    public static final BackgroundPainter BACKGROUND_PAINTER = createLightDarkVariants(
            createNinePatch(new Identifier(BetterAnvil.MOD_ID,"textures/gui/painters/panel_light.png")),
            createNinePatch(new Identifier(BetterAnvil.MOD_ID,"textures/gui/painters/panel_dark.png"))
    );

    private static final Identifier SEARCH = new Identifier(BetterAnvil.MOD_ID,"textures/gui/buttons/search.png");
